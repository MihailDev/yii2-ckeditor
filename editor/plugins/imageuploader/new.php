...
<div class="container">
    <div class="login">
        ...
        <h3 class="disable"
            onclick="window.open('http://imageuploaderforckeditor.altervista.org/disable_pw.html','about:blank', 'toolbar=no, scrollbars=yes, resizable=no, width=900, height=600');">
            How can I disable the password protection? (external link)</h3>
    ...
    <p class="description">
        The default upload folder is <b>ckeditor/plugins/imageuploader/uploads</b>. You can change it in the
        <b>settings</b> panel.
    </p>
