    ...
    return {
        ...
        contents: [{
            ...
            elements: [{
                type: "html",
                id: "securityMsg",
                html: '\x3cdiv style\x3d"white-space:normal;width:340px"\x3e' + e.securityMsg + "\x3c/div\x3e"
            }, {
                type: "html",
                id: "pasteMsg",
                html: '\x3cdiv style\x3d"white-space:normal;width:340px"\x3e' + e.pasteMsg + "\x3c/div\x3e"
            },
                {
                    ...
                    if (CKEDITOR.env.ie && !CKEDITOR.env.edge) {
                        var g = CKEDITOR.dom.element.createFromHtml('\x3cspan tabindex\x3d"-1" style\x3d"position:absolute" role\x3d"presentation"\x3e\x3c/span\x3e');
                        g.on("focus", function () {
                            setTimeout(function () {
