...
(function () {
    ...
    (function () {
        function D(a) {
            ...
            function e() {
                ...
                (this.widget.focus(), delete this.focused), delete this.deflated; else {
                    ...
                    if (d) {
                        ...
                        "center" == e ? b && c.addClass(d[1]) : "none" != e && c.addClass(d[q[e]])
            ...
            return {
                ...
                init: function () {
                    ...
                    e.align || (c = e.hasCaption ? this.element : c, f ? (c.hasClass(f[0]) ? e.align = "left" : c.hasClass(f[2]) && (e.align = "right"), e.align ? c.removeClass(f[q[e.align]]) : e.align = "none") : (e.align = c.getStyle("float") || "none", c.removeStyle("float")));
                    a.plugins.link && this.parts.link && (e.link = CKEDITOR.plugins.link.parseLinkAttributes(a, this.parts.link), (c = e.link.advanced) && c.advCSSClasses && (c.advCSSClasses = CKEDITOR.tools.trim(c.advCSSClasses.replace(/cke_\S+/, ""))));
                    this.wrapper[(e.hasCaption ?
                ...
                getClasses: function () {
                    ...
                    return function () {
                        var b = this.repository.parseElementClasses(m(this).getAttribute("class")), e;
        ...
        function H(a) {
            var b = n(a), e = a.config.image2_captionedClass;
            return function (a, g) {
                var d = {width: 1, height: 1}, c = a.name, h;
                if (!a.attributes["data-cke-realelement"] && (b(a) ? ("div" == c && (h = a.getFirst("figure")) && (a.replaceWith(h),
                        a = h), g.align = "center", h = a.getFirst("img") || a.getFirst("a").getFirst("img")) : "figure" == c && a.hasClass(e) ? h = a.getFirst("img") || a.getFirst("a").getFirst("img") : r(a) && (h = "a" == a.name ? a.children[0] : a), h)) {
        ...
        function I(a) {
            ...
            return function (a) {
                ...
                "none" != d && (c = CKEDITOR.tools.parseCssText(g.style || ""), "center" == d && "figure" == a.name ? a = a.wrapWith(new CKEDITOR.htmlParser.element("div", b ? {"class": b[1]} : {style: "text-align:center"})) : d in {
                    left: 1,
                    right: 1
                } && (b ? f.addClass(b[q[d]]) : c["float"] = d), b || CKEDITOR.tools.isEmpty(c) || (g.style = CKEDITOR.tools.writeCssText(c)));
                return a
            }
        }
        ...
        function G(a) {
            ...
            g.on("mousedown", function (c) {
                ...
                var h = a.parts.image, A = "right" == a.data.align ? -1 : 1, k = c.data.$.screenX, K = c.data.$.screenY, m = h.$.clientWidth, q = h.$.clientHeight, v = m / q, n = [], r = "cke_image_s" + (~A ? "e" : "w"), B, t, u, z, x, p, y;
                b.fire("saveSnapshot");
                l("mousemove", function (a) {
                    ...
                    p = K - B.screenY;
                    y = Math.abs(x / p);
                    1 == A ? 0 >= x ? 0 >= p ? d() : y >= v ? d() : w() : 0 >= p ? y >= v ? w() : d() : w() : 0 >= x ? 0 >= p ? y >= v ? w() : d() : w() : 0 >= p ? d() : y >= v ? d() : w();
            ...
            return function (f) {
                ...
                if (g) {
                    ...
                    g.on("refresh", function (b) {
                        var c = k(a), g = {right: 1, left: 1, center: 1};
        ...
        function M(a) {
            ...
            }), a.getCommand("unlink").on("refresh",
                function (b) {
                    var e = k(a);
        ...
        function E(a) {
            ...
            b ? (a.div.classes = b[1], a.p.classes = a.div.classes, a.img.classes = b[0] + "," + b[2], a.figure.classes += "," +
                a.img.classes) : (a.div.styles = "text-align", a.p.styles = "text-align", a.img.styles = "float", a.figure.styles = "float,display");
            return a
        }
        ...
        var N = new CKEDITOR.template('\x3cfigure class\x3d"{captionedClass}"\x3e\x3cimg alt\x3d"" src\x3d"" /\x3e\x3cfigcaption\x3e{captionPlaceholder}\x3c/figcaption\x3e\x3c/figure\x3e'),
            q = {left: 0, center: 1, right: 2}, J = /^\s*(\d+\%)\s*$/i;
        CKEDITOR.plugins.add("image2", {
            ...
            init: function (a) {
                var b = a.config, e = a.lang.image2, f = D(a);
                ...
                var b = {left: 1, right: 1, center: 1, block: 1}, e = L(a), f;
                for (f in b)e(f);
                M(a)
            }
        });
            ...
            stateShifter: function (a) {
                ...
                var f = a.document, g = a.config.image2_alignClasses, d = a.config.image2_captionedClass, c = a.editable(), h = ["hasCaption", "align", "link"], k = {
                    align: function (c, d, e) {
                        var f = c.element;
                        c.changed.align ? c.newData.hasCaption || ("center" == e && (c.deflate(), c.element = b(a, f)), c.changed.hasCaption || "center" != d || "center" == e || (c.deflate(), d = f.findOne("a,img"), d.replace(f), c.element = d)) : "center" == e && c.changed.hasCaption && !c.newData.hasCaption && (c.deflate(), c.element = b(a, f));
                        !g && f.is("figure") && ("center" ==
                        e ? f.setStyle("display", "inline-block") : f.removeStyle("display"))
                    }, hasCaption: function (b, c, g) {
                        b.changed.hasCaption && (c = b.element.is({
                            img: 1,
                            a: 1
                        }) ? b.element : b.element.findOne("a,img"), b.deflate(), g ? (g = CKEDITOR.dom.element.createFromHtml(N.output({
                            captionedClass: d,
                        ...
                        if (b.changed.link) {
                            var e = b.element.is("img") ? b.element : b.element.findOne("img"),
                                g = b.element.is("a") ? b.element : b.element.findOne("a"), h = b.element.is("a") && !d || b.element.is("img") && d, k;
                            h && b.deflate();
                            d ? (c || (k = f.createElement("a", {attributes: {href: b.newData.link.url}}), k.replace(e), e.move(k)), d = CKEDITOR.plugins.link.getLinkAttributes(a, d), CKEDITOR.tools.isEmpty(d.set) || (k || g).setAttributes(d.set), d.removed.length && (k || g).removeAttributes(d.removed)) : (d = g.findOne("img"), d.replace(g), k = d);
                            h && (b.element = k)
                        }
                    }
                };
    ...
    CKEDITOR.config.plugins = 'button,toolbar,notification,autosave,basicstyles,blockquote,dialogui,dialog,clipboard,panelbutton,panel,floatpanel,colorbutton,colordialog,menu,contextmenu,dialogadvtab,div,elementspath,enterkey,entities,popup,filebrowser,find,floatingspace,listblock,richcombo,font,format,horizontalrule,image,indent,indentblock,indentlist,justify,fakeobjects,link,list,liststyle,magicline,maximize,pagebreak,pastefromword,pastetext,removeformat,resize,selectall,showblocks,showborders,stylescombo,tab,table,tabletools,templates,undo,wysiwygarea,lineutils,widget,image2';
    ...
    (function () {
        ...
        if (CKEDITOR.env.hidpi) setIcons('bold,0,,italic,24,,strike,48,,subscript,72,,superscript,96,,underline,120,,blockquote,144,,copy-rtl,168,,copy,192,,cut-rtl,216,,cut,240,,paste-rtl,264,,paste,288,,bgcolor,312,,textcolor,336,,creatediv,360,,find-rtl,384,,find,408,,replace,432,,horizontalrule,456,,image,480,,indent-rtl,504,,indent,528,,outdent-rtl,552,,outdent,576,,justifyblock,600,,justifycenter,624,,justifyleft,648,,justifyright,672,,anchor-rtl,696,,anchor,720,,link,744,,unlink,768,,bulletedlist-rtl,792,,bulletedlist,816,,numberedlist-rtl,840,,numberedlist,864,,maximize,888,,pagebreak-rtl,912,,pagebreak,936,,pastefromword-rtl,960,,pastefromword,984,,pastetext-rtl,1008,,pastetext,1032,,removeformat,1056,,selectall,1080,,showblocks-rtl,1104,,showblocks,1128,,table,1152,,templates-rtl,1176,,templates,1200,,redo-rtl,1224,,redo,1248,,undo-rtl,1272,,undo,1296,', 'icons_hidpi.png'); else setIcons('bold,0,auto,italic,24,auto,strike,48,auto,subscript,72,auto,superscript,96,auto,underline,120,auto,blockquote,144,auto,copy-rtl,168,auto,copy,192,auto,cut-rtl,216,auto,cut,240,auto,paste-rtl,264,auto,paste,288,auto,bgcolor,312,auto,textcolor,336,auto,creatediv,360,auto,find-rtl,384,auto,find,408,auto,replace,432,auto,horizontalrule,456,auto,image,480,auto,indent-rtl,504,auto,indent,528,auto,outdent-rtl,552,auto,outdent,576,auto,justifyblock,600,auto,justifycenter,624,auto,justifyleft,648,auto,justifyright,672,auto,anchor-rtl,696,auto,anchor,720,auto,link,744,auto,unlink,768,auto,bulletedlist-rtl,792,auto,bulletedlist,816,auto,numberedlist-rtl,840,auto,numberedlist,864,auto,maximize,888,auto,pagebreak-rtl,912,auto,pagebreak,936,auto,pastefromword-rtl,960,auto,pastefromword,984,auto,pastetext-rtl,1008,auto,pastetext,1032,auto,removeformat,1056,auto,selectall,1080,auto,showblocks-rtl,1104,auto,showblocks,1128,auto,table,1152,auto,templates-rtl,1176,auto,templates,1200,auto,redo-rtl,1224,auto,redo,1248,auto,undo-rtl,1272,auto,undo,1296,auto', 'icons.png');
    })();
    CKEDITOR.lang.languages = {"en": 1, "hu": 1};
}());